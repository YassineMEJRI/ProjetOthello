...
int Othellier::possibleMoves(int couleur){ /* tester les cases possibles (lignes hor verti diagonale*/
  ...
  for (int i = 0; i < 8; i++) {
    for (int j = 0; j < 8; j++) {
      ...
      if (grille[i][j].getCouleur() == couleur) {
        ...
        do {
          k++;
        } while ((8 > k) && (grille[i][k].getCouleur() == couleuradd));
        ...
        do {
          k--;
        } while ((0 <= k) && (grille[i][k].getCouleur() == couleuradd));
        ...
        do {
          k++;
        } while ((8 > k) && (grille[k][j].getCouleur() == couleuradd));
        ...
        do {
          k--;
        } while ((0 <= k) && (grille[k][j].getCouleur() == couleuradd));
        ...
        do {
          k++;
          k1++;
        } while ((8 > k1) && (8 > k) && (grille[k][k1].getCouleur() == couleuradd));
        ...
        do {
          k--;
          k1--;
        } while ((0 <= k1) && (0 <= k) && (grille[k][k1].getCouleur() == couleuradd));
        ...
        do {
          k++;
          k1--;
        } while ((0 <= k1) && (8 > k) && (grille[k][k1].getCouleur() == couleuradd));
        ...
        do {
          k--;
          k1++;
        } while ((0 <= k) && (8 > k1) && (grille[k][k1].getCouleur() == couleuradd));
  ...
  for(int o=0;o<64;o++)
    log<<o<<":"<<tabPossibleMoves[o]<<" | ";

    for(int o=0;o<64;o++){
        if(tabPossibleMoves[o]!=0)
            return 1;
    }
    return 0;
  log<<std::endl;
...
int* Othellier::getPossibleMoves(){
    log << "in getPossibleMoves\n";
    return tabPossibleMoves;
}
...
void Othellier::setnbPionsTotale(int nb ){
    nbPionsTotale=nb;
}
